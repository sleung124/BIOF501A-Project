#!/bin/bash
# =============================================================
# MAY NOT BE RELEVANT; WORKING WITH JUST WORKFLOW.NF FOR NOW  
# Use this script now to run nextflow with relevant parameters
# And allowing for running with resume
# Inspired from Tony Liangs project organization, from his BIOF501A project
# Author: Samuel Leung
# =============================================================

# Configuration options
NXF_SRC_MAIN=workflow.nf # Main script to run
...
# bash run_nxf.sh -b allows for redireting output of the log to DGE_pipeline.log
