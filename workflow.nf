...
workflow {
    ...
    degs = FIND_DEGS(params.degs.QUICK_SAMPLE, params.degs.SET_SEED, cell_deconv.cell_deconvolved, preprocessed.processed)
    FIND_PATHWAYS(params.pathways.PVAL_THRESH, params.pathways.SHOW_TERMS, params.pathways.NUMCHAR, params.pathways.ORDER_BY, params.pathways.SPECIES, degs.degs)
}
